  ...
  return (
    <form action={action} className={styles.form}>
      ...
      <div className={styles.checkboxGrid}>
        ...
        <div className={styles.checkboxCard}>
          <label className={styles.checkbox}>
            <input name="priceOnRequest" type="checkbox" defaultChecked={artwork?.priceOnRequest ?? true} />
            Price on request
          </label>
          <p className={styles.fieldHint}>Hide fixed pricing and route visitors to the inquiry form instead.</p>
        </div>
      </div>
